        ...
        <div>
          {user.id == 1 ? (
            <div className="wrapper_favorite">
              <Button onClick={admEdit} id="buttonFavorite" />
              <BsPencil />
            </div>
          ) : (
            <div className="wrapper_favorite">
              <Button onClick={actionCheck} id="buttonFavorite" />

              {date.user_id == user.id ? (
                <BsHeartFill id="fillHeart" />
              ) : (
                <BsHeart />
              )}
            </div>
          ...
          <div
            className={window.innerWidth < 832 ? "wrapper_plate_mobile" : ""}
          >
            <Link to={`/Details/${date.id}`}>
              <div className="wrapper_img">
                <img
                  src={`${api.defaults.baseURL}/files/${date.image}`}
                  alt="imagem do prato"
                />
              </div>
              ...
              <div className="wrapper_price">
                <span>
                  {Number(date.price).toLocaleString("pt-br", {
                    style: "currency",
                    currency: "BRL",
                  })}
                </span>
          ...
          {user.id == 1 ? null : (
            <div
              ...
              id={window.innerWidth < 832 ? "wrapper_buttons_mobile" : ""}
            >
